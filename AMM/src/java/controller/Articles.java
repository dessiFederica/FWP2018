...
public class Articles extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String username = request.getParameter("iMieiArticoli");
        Utente utente = UtenteFactory.getInstance().getUtenteByUsername(username);
        if (utente.getTipologiaUtente().equals("autore")) {
            List<Articolo> listaArticoli = ArticoloFactory.getInstance().getListaNewsByAutore(utente);

            request.setAttribute("listaArticoli", listaArticoli);
            request.setAttribute("listalength", listaArticoli.size());
